...
Run a `/grill-me` session, using the `/domain-modeling` skill to capture decisions as Architecture Decision Records.

When grilling concludes, `/grill-me` will automatically:
