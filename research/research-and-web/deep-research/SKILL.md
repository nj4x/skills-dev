---
name: deep-research
description: Full deep-research workflow via DeepAPI — build a one-paragraph prompt, run it, save a cited markdown report.
disable-model-invocation: true
---

# Deep Research (via DeepAPI)

We use DeepAPI (deepapi.co) for all deep research.
