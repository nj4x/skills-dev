...
description: Build a structured document through Q&A — one question at a time, patch the file after each answer, repeat until complete.
...
Use only when the user is the author of content; not when you're proposing content first.
