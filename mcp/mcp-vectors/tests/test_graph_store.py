...
def test_replace_file_entity_map_returns_version(tmp_path):
    ...
    version = gs.replace_file_entity_map(em, ROOT, "/file.py")
    assert isinstance(version, int)
    assert version > 0
...
def test_cas_deadlock_replace_file_resets_committed_build_id(tmp_path):
    ...
    # Step 1: first index
    v0 = gs.replace_file_entity_map(em, ROOT, "/a.py")
    assert v0 > 0
    ...
    v1 = gs.replace_file_entity_map(em, ROOT, "/a.py")
...
def test_cas_deadlock_delete_file_resets_committed_build_id(tmp_path):
    ...
    v0 = gs.replace_file_entity_map(em, ROOT, "/b.py")
...
def test_toctou_cas_only_one_concurrent_caller_wins(tmp_path):
    ...
    version = gs.replace_file_entity_map(em, ROOT, "/a.py")
