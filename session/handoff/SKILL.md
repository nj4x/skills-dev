...
## 8. Suggested Skills
<Skills the fresh agent should invoke for this work, each with a word on when. Omit if none apply.
- /code-review before merging the auth branch
- /goal for the mechanical coverage-lift once logout lands>
